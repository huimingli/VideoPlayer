...
QT_MOC_LITERAL(1, 12, 14), // "sendVideoFrame"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7) // "cv::Mat"

    },
    "VideoThread\0sendVideoFrame\0\0cv::Mat"
};
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendVideoFrame((*reinterpret_cast< cv::Mat(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (VideoThread::*_t)(cv::Mat );
